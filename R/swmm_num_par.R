...
swmm_num_par <- function(type = "data.frame", inf_m = "GREEN_AMPT") {
  ...
  if (type == "data.frame" & inf_m == "GREEN_AMPT") {
    par <- data.frame(subcat_area  = c(1, "subcatchment", "gis", "hydrology", "Yes", 0.7, 1.3, "scale", "state", "subcatchment area", "ha"),
                      ...
                      subarea_mann_imper = c(0.013, "subarea", "gis", "hydrology", "Yes", 0.010, 0.033, "absolute", "state", "manning value for impervious area", "-"),
                      subarea_mann_per = c(0.2, "subarea", "gis", "hydrology", "Yes", 0.02, 0.8, "absolute", "state", "manning value for pervious area", "-"),
                      subarea_stora_imper = c(1.778, "subarea", "gis", "hydrology", "Yes", 0.3, 2.5, "absolute", "state", "storage for impervious area", "mm"),
                      subarea_stora_per = c(3.81, "subarea", "gis", "hydrology", "Yes", 0.5, 10, "absolute", "state", "storage for pervious area", "mm"),
                      subarea_stora_zero = c(10, "subarea", "gis", "hydrology", "Yes", 0, 100, "absolute", "state", "percentage of zero storage for impervious area", "-"),
                      subarea_PctRoute2P = c(16, "subarea", "gis", "hydrology", "Yes", 5, 100, "absolute", "state", "percentage to route within a subcatchment, subarea routing", "%"),
